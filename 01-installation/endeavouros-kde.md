...
- [EndeavourOS KDE Installation Guide](#endeavouros-kde-installation-guide)
  ...
  - [Install Core Applications](#install-core-applications)
    ...
    - [Step 3: Install TypeScript and NestJS (Optional)](#step-3-install-typescript-and-nestjs-optional)
      ...
      - [Method B: Use Local Project Installation (Recommended for Projects)](#method-b-use-local-project-installation-recommended-for-projects)
      - [Method C: Use nvm (Node Version Manager) – Avoids Permission Issues](#method-c-use-nvm-node-version-manager--avoids-permission-issues)
...
Node.js is a JavaScript runtime built on Chrome's V8 JavaScript engine, and npm is the Node.js package manager. They are essential for developing and running JavaScript applications.
...
> **⚠️ Warning – Global npm Installation:** Using `sudo npm install -g` can cause conflicts with pacman-managed packages (as covered in the [Arch Linux post-install guide](./arch-post-install.md#error-3-npmnodejs-file-exists-conflict-specific-fix)). If you encounter "file exists" errors, you may need to remove conflicting files or use a different method.
...
#### Method B: Use Local Project Installation (Recommended for Projects)
...
#### Method C: Use nvm (Node Version Manager) – Avoids Permission Issues
...
> **💡 Recommendation:** For most users, **Method B (local project installation)** is safest and avoids system conflicts. Use **Method A** only if you understand the risks.
