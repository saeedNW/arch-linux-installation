...
| **Utilities**            | `CodeSnap`, `Explorer Exclude`, `Ignore files`, `Import Cost`, `Nested Comments`, `Persian - Code Spell Checker`, `Pretty TypeScript Errors`, `Rainbow Brackets`, `Select Line Status Bar`, `Toggle Quotes` |
