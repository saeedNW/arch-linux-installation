...
| Category                 | Extensions                                                                                                                                                                                                            |
| ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Core**                 | `advanced-new-file`, `Better Comments`, `Bracket Pair Colorizer`, `Code Spell Checker`, `Persian - Code Spell Checker`, `CodeSnap`, `Error Lens`, `Nested Comments`, `Rainbow Brackets`, `Todo Tree`, `Toggle Quotes` |
...
| **Language Support**     | `GraphQL`, `HTML CSS Support`, `Lua`, `Proto Lint`, `vscode-proto3`, `nginx.conf hint`, `Pretty TypeScript Errors`, `Import Cost`                                                                                     |
| **Snippets**             | `JavaScript (ES6) code snippets`, `Node snippets`                                                                                                                                                                     |
| **Containers & DevOps**  | `Docker`, `Docker DX`                                                                                                                                                                                                 |
| **Theming & Icons**      | `Atom Material Icons`, `Nord Theme`                                                                                                                                                                                   |
| **Utilities**            | `Explorer Exclude`, `Ignore files`, `Select Line Status Bar`, `Settings Sync`                                                                                                                                         |
